...
const symName = "github.com/inovacc/mod/cmd/addr2line.TestAddr2Line"
...
func TestAddr2Line(t *testing.T) {
	...
	out, err := testenv.Command(t, testenv.GoToolPath(t), "test", "-c", "-o", exepath, "github.com/inovacc/mod/cmd/addr2line").CombinedOutput()
	if err != nil {
