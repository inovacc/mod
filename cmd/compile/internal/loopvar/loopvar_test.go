...
func TestLoopVarInlinesGo1_21(t *testing.T) {
	...
	root := "github.com/inovacc/mod/cmd/compile/internal/loopvar/testdata/inlines"
...
func TestLoopVarHashes(t *testing.T) {
	...
	for _, arg := range []string{"v001100110110110010100100", "vx336ca4"} {
		...
		mCount = countMatches(m, "github.com/inovacc/mod/cmd/compile/internal/loopvar/testdata/inlines/main.go:27:6: .* \\[bisect-match 0x7802e115b9336ca4\\]")
