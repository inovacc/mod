...
// for "github.com/inovacc/mod/cmd/internal/dwarf" and <autogenerated> (which is not really a file, but the compiler sees it)
//
...
//
// {"version":0,"package":"github.com/inovacc/mod/cmd/compile/internal/ssa","goos":"darwin","goarch":"amd64",
