...
// 1.11–1.21.
//
// The package started as a copy of Go 1.19's github.com/inovacc/mod/module/internal/trace, but has been
...
import (
	...
	"errors"
	"fmt"
	"github.com/inovacc/mod/module/internal/trace/event"
	"github.com/inovacc/mod/module/internal/trace/version"
	"io"
	"math"
	"slices"
	"sort"
...
func Parse(r io.Reader, vers version.Version) (Trace, error) {
	// We accept the version as an argument because github.com/inovacc/mod/module/internal/trace will have
