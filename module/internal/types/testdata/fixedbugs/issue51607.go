...
type (
	...
	_ interface {
		int | int /* ERROR "overlapping terms int and int" */
	}
	_ interface {
		int | ~ /* ERROR "overlapping terms ~int and int" */ int
	}
	_ interface {
		~int | int /* ERROR "overlapping terms int and ~int" */
	}
	...
	_ interface {
		T1 | bool | string | T1 | bool /* ERROR "overlapping terms bool and bool" */ | string /* ERROR "overlapping terms string and string" */
	}
	_ interface {
		T1 | bool | string | T2 | ~ /* ERROR "overlapping terms ~bool and bool" */ bool | ~ /* ERROR "overlapping terms ~string and string" */ string
	}
